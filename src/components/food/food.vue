<template>
    <!--
        ...
        4. 可以考虑将新旧price做成组件
        5. 引入better-scroll
        6. 购物车按钮 点击阻止冒泡：@click上添加修饰符
        7. 添加购物车消失的动画，延迟获取小球的时间
        8. split组件
        9. ratingselelct组件
        10. 子组件与父组件之间的通信？？？
        11. filters的用法和日期函数编写 -->
        ...
        <div v-show="showFlag" class="food" ref="food">
            <div class="food-content">
                ...
                <div class="rating">
                    ...
                    <ratingselect @select-type="selectRating" @toggle-content="toggleContent" :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="food.ratings"></ratingselect>
